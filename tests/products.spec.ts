...
test.describe('Products Page Functionalities', () => {
  ...
  test('TC_09: Search Product', async ({ homePage, productsPage }) => {
    ...
    const count = await productsPage.expectSearchedProductsAreVisible(data.products.searchProduct);
  ...
  test('TC_19: View & Cart Brand Products', async ({ homePage, productsPage }) => {
    ...
    expect(itemsBrandOne).toBeTruthy();
    ...
    expect(itemsBrandTwo).toBeTruthy();
  });
