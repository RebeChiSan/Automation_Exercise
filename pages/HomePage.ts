...
export class HomePage extends BasePage {
  ...
  async clickOnDressSubcategory() {
    await this.womenSubCategoriesList.waitFor({ state: 'visible' });
    await this.womenSubCategoriesList.click();
    await this.dressOption.waitFor({ state: 'visible' });
    await this.dressOption.click();
  }

  async clickOnJeansSubcategory() {
    await this.menSubCategoriesList.waitFor({ state: 'visible' });
    await this.menSubCategoriesList.click();
    await this.jeansOption.waitFor({ state: 'visible' });
